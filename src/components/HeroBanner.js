...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '197px', xs: '70px' }, ml: { sm: '50px' }}} position="relative" p="20px">
    ...
    <Typography color="#FF2625" fontWeight="bold" fontSize="80px" className='explore-exercises-button'>
    ...
    <Typography fontSize="22px" fontFamily="'Nunito', sans-serif" fontWeight="bold" lineHeight="35px">
